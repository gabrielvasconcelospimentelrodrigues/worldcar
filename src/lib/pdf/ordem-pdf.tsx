...
import { brl, data, dataHora, documento, numeroDoc, telefone } from "@/lib/format";
  ...
  return (
    <View style={est.cabecalho}>
      <View style={est.marca}>
        <Text style={est.marcaCaixa}>W</Text>
        <View>
          <Text style={est.marcaNome}>{empresa.nome}</Text>
          <Text style={est.marcaSub}>ESTÉTICA AUTOMOTIVA</Text>
        </View>
      </View>
      ...
      <View style={est.bloco}>
        ...
        <View style={est.blocoCorpo}>
          ...
          <View style={est.linha}>
            ...
            <Campo
              rotulo="Previsão"
              valor={os.previsaoEntrega ? data(os.previsaoEntrega) : "A combinar"}
              largura="20%"
            />
          </View>
        </View>
