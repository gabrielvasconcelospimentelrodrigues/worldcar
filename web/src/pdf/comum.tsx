...
export function montarEmpresa(e: Empresa | null): DadosEmpresa {
...
export const est = StyleSheet.create({
  ...
  /**
   * O selo E o cabecalho, nao um carimbo ao lado dele.
   *
   * Antes vinha pequeno com "World Car Service" escrito em tipografia logo ao
   * lado — o nome aparecia duas vezes e a marca ficava isolada, como uma caixa
   * preta solta. Dando altura ao selo e tirando o texto repetido, o brasao volta
   * a ser o elemento principal. Largura vem da proporcao real (1,45), senao o
   * desenho estica ou sobra faixa preta.
   */
  marcaSelo: { height: 62, width: 90, objectFit: "contain" },
