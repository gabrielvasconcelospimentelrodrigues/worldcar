    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="overflow-hidden rounded-2xl bg-carvao-950 text-white">
              <div className="grid gap-8 p-8 sm:p-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-3 font-display text-3xl font-extrabold uppercase tracking-tight sm:text-4xl">
                    Cada real gasto vira desconto no próximo serviço
                  </h2>
                  <p className="mt-4 text-carvao-300">
                    Você acumula pontos automaticamente a cada serviço pago — sem
                    cartãozinho, sem app, sem precisar pedir. Quando junta o suficiente,
                    o desconto entra direto na sua próxima ordem de serviço.
                  </p>
                  <ul className="mt-6 space-y-2.5">
                    {[
                      "Pontos creditados no ato do pagamento",
                      "Quanto mais você volta, maior o seu nível",
                      "Avisamos antes de os pontos vencerem",
                    ].map((t) => (
                      <li key={t} className="flex items-center gap-2.5 text-sm text-carvao-200">
                        <CheckCircle2 className="h-4 w-4 shrink-0 text-marca-500" aria-hidden />
                        {t}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { n: "Bronze", d: "Todo cliente começa aqui" },
                    { n: "Prata", d: "A partir de R$ 1.500 no ano" },
                    { n: "Ouro", d: "A partir de R$ 5.000 no ano" },
                    { n: "Diamante", d: "A partir de R$ 15.000 no ano" },
                  ].map((n) => (
                    <div key={n.n} className="rounded-lg border border-carvao-800 bg-carvao-900 p-4">
                      <p className="font-display text-lg font-bold uppercase tracking-tight">
                        {n.n}
                      </p>
                      <p className="mt-1 text-xs leading-relaxed text-carvao-400">{n.d}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <footer className="bg-carvao-950 py-12 text-carvao-400">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-carvao-800 pt-6 text-xs sm:flex-row">
            ...
            <Link to="/entrar" className="hover:text-marca-400">
              Área interna
            </Link>
          </div>
        </div>
